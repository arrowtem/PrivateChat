...
public class SignUpActivity extends AppCompatActivity {
    ...
    loading(true);
        ...
        database.collection(Constants.KEY_COLLECTION_USERS).add(user).addOnSuccessListener(document ->
                ...
                preferenceManager.putString(Constants.KEY_USR_ID,document.getId());
    ...
    private String encodeImage(Bitmap bitmap) // encoding bitmap to string
    {
    ...
    private boolean isValidSignUp() {
        ...
        } else if (!Patterns.EMAIL_ADDRESS.matcher(binding.inputEmail.getText().toString()).matches())
        {
            ...
            showToast("passwords and not the same");
            return false;
        }
        else {
            return true;
